...
{
	[Feature(Name = "Iso-surface with depth", GroupName = "Iso-Surfacing", Description = "Demo shows isosurfacing via raycasting rendering technique. Non-transparent iso-surfaces support depth output by default. Iso value and color can be changed in legend.")]
	public class VolumeIsoRayCastingDepthDemo : FeatureDemo
	{
		...
		public override void Do(IDemoChartControl chartControl)
		{
			...
			// Inscribed semi-transparent cube.
			var cube = new Cube
			{
				Size = new Vector3F(0.6f),
				Position = new Vector3F(0.5f),
			...
			chartControl.DataSource = new RenderData[] { boundingCube, cube, sphere, rayCasting };
		}

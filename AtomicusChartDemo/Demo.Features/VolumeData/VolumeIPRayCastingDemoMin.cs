...
{
	[Feature(Name = "Min Intensity", GroupName = "Intensity projections", Description = "Demo shows minimal intensity projection via raycasting rendering technique. Maximal, minimal and average projection types can be changed in legend.")]
	class VolumeIPRayCastingDemoMin : FeatureDemo
	{
		public override void Do(IDemoChartControl chartControl)
		{
			...
			var rayCasting = new VolumeIPRayCasting
			{
				...
				ProjectionType = VolumeIPType.Min,

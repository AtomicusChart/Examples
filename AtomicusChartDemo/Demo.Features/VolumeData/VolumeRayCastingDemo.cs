...
{
	[Feature(Name = "Ray casting", GroupName = "Ray casting", Description = "Demo shows raycasting rendering technique. You can customize transfer function for ray casting and color legend.")]
	public class VolumeRayCastingDemo : FeatureDemo
	{

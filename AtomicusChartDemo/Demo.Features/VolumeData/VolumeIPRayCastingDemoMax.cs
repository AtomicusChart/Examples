...
{
	[Feature(Name = "Max Intensity", GroupName = "Intensity projections", Description = "Demo shows maximal intensity projection via raycasting rendering technique. Maximal, minimal and average projection types can be changed in legend.")]
	public class VolumeIPRayCastingDemoMax : FeatureDemo
	{
